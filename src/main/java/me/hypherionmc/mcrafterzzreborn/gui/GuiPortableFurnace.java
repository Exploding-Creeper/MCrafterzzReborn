...
public class GuiPortableFurnace extends GuiContainer {
    ...
    public GuiPortableFurnace(InventoryPlayer playerInv, PortableFurnaceMachine furnaceInv)
    {
        super((new PortableFurnaceMachine()).createContainer(playerInv));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        if (tileFurnace.isBurning(this.tileFurnace))
        {
